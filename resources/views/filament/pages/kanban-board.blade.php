                                  ...
                                  <div class="flex items-center -space-x-2">
                                          @foreach($task->members as $member)
                                            <div class="relative group">
                                                ...
                                                <div class="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-400 text-white text-sm rounded-lg px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                                                    {{ $member->name }}
                                                </div>
                                            </div>
                                          @endforeach
                               ...
                               <div class="p-4 space-y-4">
                                <div class="mb-4">
                                    ...
                                    <div class="relative" x-data="{ open: false, selected: @entangle('selectedMembers'), searchQuery: '' }">
                                        <button @click="open = !open" type="button" class="relative w-full mt-1 py-3 ps-4 pe-9 border border-slate-600 rounded bg-white cursor-pointer text-start text-sm focus:ring-2 focus:ring-blue-500">
                                        ...
                                        <template x-for="(id, index) in selected" :key="index">
                                            <div class="flex items-center space-x-2">
                                                <div class="relative group">
                                                    ...
                                                    <div class="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-400 text-white text-sm rounded-lg px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                                                        <span x-text="$refs['user-' + id].innerText"></span>
                                                    </div>
                                                </div>
